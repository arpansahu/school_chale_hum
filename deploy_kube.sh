...
TAG="latest"
NAMESPACE="default"
SECRET_NAME="school-chale-hum-secret"
ENV_FILE=".env"
...
function set_default_variables {
    IMAGE_NAME="school_chale_hum"
    KUBE_DEPLOYMENT="school-chale-hum-app"
    DEPLOYMENT_FILE="deployment.yaml"
}

# Function to set mac specific variables
function set_mac_variables {
    IMAGE_NAME="school_chale_hum_mac"
    KUBE_DEPLOYMENT="school-chale-hum-mac-app"
